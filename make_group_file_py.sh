...
function display_help() {
    ...
    echo "     -e  - comma separated list of GTEx features (promoter, CTCF, enhancer, promoterFlank, openChrom, TF_bind or all)"
    ...
    echo "     -S  - shortcut (optional, accepted values:)"
    echo "                               \"exsevere\": \"-g exon -o\""
